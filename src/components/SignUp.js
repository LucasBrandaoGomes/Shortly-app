...
export default function SignUp(){
    ...
    function SubmitSignUp(event){
        ...
        const promise = axios.post("https://shortly-project-api.herokuapp.com/signup", infoSignUp)
    ...
    return(
        <ContainerAuth >
            ...
            <Form onSubmit={SubmitSignUp} >
                ...
                <div><Cadastrar type="submit" disabled={disableButton}>{disableButton ? <ThreeDots color="white"/> : "criar conta"}</Cadastrar></div>
            </Form >
        </ContainerAuth>
   )
}
